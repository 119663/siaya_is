...
import static com.evelyne.labs.trialapp.MapsActivity.GPS_REQUEST;
                    ...
                    .addOnFailureListener((Activity) context, e -> {
                        ...
                        switch (statusCode) {
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                FancyToast.makeText(context, errorMessage, FancyToast.LENGTH_LONG, FancyToast.INFO, false).show();
                        }
                    });
        }
    }
